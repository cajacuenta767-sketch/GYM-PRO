...
export const memberFields: FieldConfig[] = [
  ...
  { name: 'status', label: 'Estado', type: 'select', options: toOptions(MEMBER_STATUS), required: true, defaultValue: 'ACTIVE' },
  { name: 'joinDate', label: 'Fecha de ingreso', type: 'date', defaultValue: new Date().toISOString().slice(0, 10) },
